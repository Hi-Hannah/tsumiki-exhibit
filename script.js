...
const END_SCREEN_DATA = {
    ...
    text_en: 'The Tsumiki building blocks for this pyramid are already available in our online shop. You can reserve your own set <a href="https://example.com" target="_blank" class="end-link">here</a>. After the exhibition ends, we’ll send you your set, or you can pick it up at the museum. By doing so, you’re not only making a sustainable choice, but also supporting the<em> more trees</em> project and our museum!',
    text_de: 'Die Tsumiki-Bauteile dieser Pyramide findest du schon jetzt in unserem Online-Shop. <a href="https://example.com" target="_blank" class="end-link">Hier</a> kannst du dir dein eigenes Set reservieren. Nach Ende der Ausstellung schicken wir dir dein Set zu oder du kannst es im Museum abholen. Damit handelst du nicht nur nachhaltig, sondern unterstützt auch das Projekt von<em> more trees</em> und unser Museum!',
